...
{
     echo 'Oops!!..You are already signed in, you can <a href="logout.php">sign out</a> if you want.';
     echo '<br>Click here to go to <a href="admin_home.php">Home </a>';
}
else
    {?>
   <div id="wrapper">
